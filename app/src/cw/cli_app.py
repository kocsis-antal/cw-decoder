...
def main() -> None:
    ...
    decode_raw_parser.add_argument("--soft-activity", action=argparse.BooleanOptionalAction, default=True)
    decode_raw_parser.add_argument("--soft-tone-on-probability", type=float, default=0.56)
    decode_raw_parser.add_argument("--soft-tone-off-probability", type=float, default=0.28)
    decode_raw_parser.add_argument("--soft-bridge-min-probability", type=float, default=0.18)
    decode_raw_parser.add_argument("--soft-bridge-max-gap-ms", type=float, default=90.0)
    decode_raw_parser.add_argument("--soft-bridge-gap-units", type=float, default=1.6)
    decode_raw_parser.add_argument("--viterbi-transition-penalty", type=float, default=1.15)
    decode_raw_parser.add_argument("--symbol-hmm-decoding", action=argparse.BooleanOptionalAction, default=True)
    decode_raw_parser.add_argument("--symbol-hmm-beam-width", type=int, default=16)
    decode_raw_parser.add_argument("--symbol-hmm-max-candidates", type=int, default=3)
    decode_raw_parser.add_argument("--symbol-hmm-unit-spread", type=float, default=0.18)
    decode_raw_parser.add_argument("--symbol-hmm-unit-steps", type=int, default=3)
    decode_raw_parser.add_argument("--symbol-hmm-transition-penalty", type=float, default=0.18)
    decode_raw_parser.add_argument("--symbol-hmm-min-unit-s", type=float, default=0.025)
    decode_raw_parser.add_argument("--symbol-hmm-max-unit-s", type=float, default=0.250)
    decode_raw_parser.add_argument("--symbol-hmm-live-interval-s", type=float, default=2.0)
    decode_raw_parser.add_argument("--lattice-decoding", action=argparse.BooleanOptionalAction, default=True)
    decode_raw_parser.add_argument("--lattice-beam-width", type=int, default=12)
    decode_raw_parser.add_argument("--lattice-max-candidates", type=int, default=3)
    decode_raw_parser.add_argument("--lattice-tone-margin-units", type=float, default=0.45)
    decode_raw_parser.add_argument("--lattice-gap-margin-units", type=float, default=0.60)
    ...
    view_events_parser = subparsers.add_parser("view-events", help="Render cw.stream.event.v1 JSONL events as the live human dashboard")
    view_events_parser.add_argument("path", nargs="?", type=Path, default=None, help="JSONL file to read; omit or use '-' for stdin")
