...
from cw.tools.legacy_decoder.stream_decode import (
    _band_energy,
...
from cw.tools.legacy_decoder.config import DecoderConfig as AnalysisDecoderConfig
...
def analyze_raw_file(
    ...
    *,
    ...
    stream_config = AnalysisDecoderConfig(
        frame_ms=frame_ms,
        hop_ms=hop_ms,
        min_tone_hz=min_tone_hz,
        max_tone_hz=max_tone_hz,
...
def _analyze_threshold(
    ...
    *,
    ...
    if first_frame_start_s:
        from cw.tools.legacy_decoder.stream_decode import _offset_runs
...
def _word_gap_boundary_from_classified(classified_runs, config: AnalysisDecoderConfig) -> float:
